...
public class Calculator {
	public static void main(String[] args) {
		...
		while (true) {
			...
			System.out.println("1. Addition"); // phep cong
			System.out.println("2. Subtraction"); // phep tru
			System.out.println("3. Multiplication"); // phep nhan
			System.out.println("4. Division"); // phep chia
			System.out.println("0. Exit");

			System.out.println("Enter number to select (0-4) !");
